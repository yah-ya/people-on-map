...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
            ...
            <div class="py-12 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase p-3">On Demand Maps</h2>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDNbfp4d2KMvKWJ-IqeAgCmzsBYepdS2WI"
    ></script>
